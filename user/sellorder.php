...
<div class="right">
 ...
 <li class="l21">
 <?
 $sqlq="select sum(money1*num+yunfei) as orderall from yjcode_order".$sestj." and ddzt='suc'";mysql_query("SET NAMES 'GBK'");$resq=mysql_query($sqlq);$rowq=mysql_fetch_array($resq);
 ...
 <?
 $sqlq="select sum(money1*num+yunfei) as orderall from yjcode_order".$sestj." and ddzt='back'";mysql_query("SET NAMES 'GBK'");$resq=mysql_query($sqlq);$rowq=mysql_fetch_array($resq);
 $money1=sprintf("%.2f",$rowq[orderall]);
 ?>

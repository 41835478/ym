...
<div class="tuijian">
 ...
 <div class="dlist dlist<?=$i?>">
  <div class="d1"><a href="<?=$au?>" target="_blank"><img border="0" src="<?=returntppd("../upload/".$row1[id]."/shop.jpg","../img/none180x180.gif")?>" width="120" height="120" /></a></div>
  <ul class="u1">
  <li class="l1"><a href="<?=$au?>" target="_blank"><?=$row1[shopname]?></a></li>
  ...
  ?>
  <a href="<?=$au?>" target="_blank" title="<?=$row2[tit]?>"><img src="<?=returntppd($tp,"../img/none180x180.gif")?>" width="70" height="70" border="0" /></a>
  <? }?>
  </div>
 </div>
 <? $i++;}?>
...
<div class="sleft">
 ...
 ?>
 <div class="slist">
  <div class="d1"><a href="<?=$au?>" target="_blank"><img border="0" src="<?=returntppd("../upload/".$row[id]."/shop.jpg","../img/none180x180.gif")?>" /></a><br>已有 <?=$row[djl]?> 人关注</div>
  <ul class="u1">
  ...
  <li class="l4"><a href="http://wpa.qq.com/msgrd?v=3&uin=<?=$row[uqq]?>&site=<?=weburl?>&menu=yes" target="_blank" class="a1 g_bg0">与TA联系沟通</a><a href="<?=$au?>" target="_blank" class="a2">进入店铺</a></li>
  </ul>
  <div class="d2">

...
<div class="right" id="right">
 ...
 <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","xin_qh","ADI05","ADI13","ADI14","ADTOP","xin_01","xin_02","xin_03","xin_04","xin_05");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页切换图片","顶部搜索框右方广告","首页底部合作伙伴","首页底部友情链接","全站顶部广告","首页商品列表左侧上方广告","首页商品列表左侧下方广告","热门商品下方横幅","首页资讯区切换","首页资讯区右侧广告");
 $adsize=array("100*?","1150*?","1150*?","1150*?","","1920*424","250*75","150*52","","1150*?","220*420","220*160","1150*?","425*226","290*175","310*125");

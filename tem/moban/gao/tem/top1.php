...
<div class="yjcode">
 ...
 <!--主导航下拉开始-->
   <div class="menun fontyh" id="leftmenu" style="display:none;">
    ...
    <div  id="yhmenu<?=$i?>" class="menu1" onmouseover="yhmenuover(<?=$i?>)" onmouseout="yhmenuout(<?=$i?>)">
       <div class="lu1"><a href="<?=weburl?>product/search_j<?=$row1[id]?>v.html"><span class="s0"><img src="<?=weburl?>upload/type/type1_<?=$row1[id]?>.png" /></span><span class="s1"><?=$row1[type1]?></span><span class="s2"><img src="<?=weburl?>homeimg/mj.png" /></span></a></div>
	   <div id="rmenu<?=$i?>" class="rmenu rmenu1" style="display:none;margin-top:-<?=50*$i-1?>px;" >
      ...
      <li class="l2">
       ...
       <a href="<?=weburl?>product/search_j<?=$row1[id]?>v_k<?=$row2[id]?>v_m<?=$row3[id]?>v.html" class="ays"><?=$row3[type3]?></a>&nbsp;&nbsp;|&nbsp;&nbsp;
       <? }?>
       <a href="<?=weburl?>product/search_j<?=$row1[id]?>v.html">更多</a>
      </li>
      </ul>
	  <? }?>
     </div>

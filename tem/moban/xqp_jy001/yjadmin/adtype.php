...
<div class="right">
 ...
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","导航菜单","首页切换图片","欢迎新会员左侧","首页底部友情链接","全站顶部广告","切换大图下方横幅","快捷菜单左侧小图标","首页商品列表小图标","底部宣传语1","底部宣传语2","首页统计右侧广告","右侧自定义客服");
 $adsize=array("100*?","1150*?","1150*?","","1920*400","460*50","","460*50","1150*?","18*17","26*22","","","550*50","");

 ...
 <span id="typeallnum" style="display:none;"><?=$ai?></span>
   ...
   <div class="menun fontyh" id="leftmenu" style="display:none;">
    <!--商品B-->
     ...
     <div class="lu1">
	 <a href="<?=weburl?>product/search_j<?=$row1[id]?>v.html">
	 <span class="s0"><img src="<?=weburl?>upload/type/type1_<?=$row1[id]?>.png" /></span>
	 <span class="s1"><?=$row1[type1]?></span>
	 <span class="s2"><img src="<?=weburl?>homeimg/mj.png" /></span></a></div>

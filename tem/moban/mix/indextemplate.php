...
<? $i++;}?>
 ...
 <ul class="u1 u1<?=$i?>">
 <li class="l1"><a href="<?=$au?>" target="_blank"><img class="tp" border="0" src="<?=returntppd(returntp("bh='".$row1[bh]."'",""),"img/none200x200.gif")?>" width="270" height="294" /></a><span class="djs" id="djs<?=$i?>">正在加载</span></li>
...
<div class="yjcode">
 ...
 <div class="port-1 effect-2">
  <div class="image-box"><img src="<?=returntppd(returntp("bh='".$row[bh]."'",""),"img/none180x180.gif")?>" width="257" height="257" alt="<?=$row[tit]?>"></div>

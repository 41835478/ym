 ...
 createDir("../../".$targetFolder);
  if(returncount("yjcode_tp where bh='".$bh."'")<7){
   if(is_uploaded_file($_FILES['inp1']['tmp_name'])){
	...
	intotable("yjcode_tp","bh,tp,type1,sj,userid,xh","'".$bh."','".$wjv."','商品','".$sj."',".$userid.",".$nxh."");
   }
  }
...
#uping{float:left;padding:1px 0 0 0;height:20px;text-align:center;width:98px;border:#00B7EE dotted 1px;font-family:"Microsoft YaHei",微软雅黑,"MicrosoftJhengHei",华文细黑,STHeiti,MingLiu;font-size:13px;color:#ff6600;background-color:#f2f2f2;}
</style>

...
<div class="indexpro box" onClick="gourl('productlist.php')">
 ...
 <div class="d2">我的商品(共<?=returncount("yjcode_pro where zt<>99 and userid=".$rowuser[id]."")?>件)</div>
 <div class="d3"><img src="img/jianright.png" /></div>
</div>
<div class="indexplist box">
 <div class="d1">
 <? while1("*","yjcode_pro where userid=".$rowuser[id]." and zt<>99 order by lastsj desc limit 4");while($row1=mysql_fetch_array($res1)){?>

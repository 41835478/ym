...
else if(parseInt(rv)>0){f1.action="/codepay/codepay_buy.php?carid="+x;}
...
<div class="boxcap box">
 ...
 <input name="R1" id="ips1" type="radio" value="1"<? if($ifpays==0){?> checked="checked"<? $ifpays=1;}?> /><img src="../../user/img/pay/alipay.gif" onClick="xz('ips1')" />
 </li>
 <li class="l2">
 <input name="R1" id="ips3" type="radio" value="3"<? if($ifpays==0){?> checked="checked"<? $ifpays=1;}?> /><img src="../../user/img/pay/wxpay.gif" onClick="xz('ips3')" />
 </li>
 <li class="l2">
 <input name="R1" id="ips2" type="radio" value="2"<? if($ifpays==0){?> checked="checked"<? $ifpays=1;}?> /><img src="../../user/img/pay/tenpay.gif" onClick="xz('ips2')" />
 </li>
   <? }?>

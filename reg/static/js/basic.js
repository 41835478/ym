...
function updatePageses() {
  if (xmlHttpses.readyState == 4) {
   ...
   if(response=="0"){document.getElementById("notlogin").style.display="";document.getElementById("yeslogin").style.display="none";return false;document.getElementById("notlogin1").style.display="";document.getElementById("yeslogin1").style.display="none";return false;}
   else{
   r=response.split(" ");
  ...
  document.getElementById("yeslogin1").style.display="";
   ...
   document.getElementById("yesuid1").innerHTML=r[0];
      document.getElementById("imoney1").innerHTML=r[2]+"元";

...
<div class="right">
 ...
 <input type="hidden" name="jvs" value="control" />
  ...
  <ul class="rcap"><li class="l1"></li><li class="l2">码支付</li><li class="l3"></li></ul>
 <ul class="uk">
 <li class="l1">ID：</li>
 <li class="l2">
 ...
 <span class="hui">请输入码支付ID <span class="red"></span></span> <span class="fd"><a href="//codepay.fateqq.com/" target="_blank" class="red">[申请]</a></span>
 </li>
  <li class="l1">密钥：</li>
 <li class="l2">

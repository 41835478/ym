...
<div class="right">
 ...
 <li class="l2"><input name="m1" value="<?=$row[mailname];?>" size="20" type="text" class="inp" /><span class="fd"><a href="http://www.yj99.cn/faq/view9.html" target="_blank">如何设置？</a></span></li>
 <li class="l1">邮箱密码：</li>
 <li class="l2">

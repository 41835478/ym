...
if($_GET[control]=="add"){
 ...
 intotable("yjcode_type","admin,type1,type2,xh,sj,buyform","2,'".sqlzhuru($_POST[t0])."','".sqlzhuru($_POST[t1])."',".sqlzhuru($_POST[t2]).",'".$sj."','".sqlzhuru($_POST[buyform])."'");$id=mysql_insert_id();
 ...
 updatetable("yjcode_type","sj='".$sj."',xh=".sqlzhuru($_POST[t2]).",buyform='".sqlzhuru($_POST[buyform])."' where id=".$_GET[id]);

...
function AdminSes_audit(){if($_SESSION["SHOPADMIN"]=="" || $_SESSION["SHOPADMINPWD"]==""){php_toheader("index.php");}global $adminqx;$sqladmin="select * from yjcode_admin where adminuid='".$_SESSION["SHOPADMIN"]."' and adminpwd='".$_SESSION["SHOPADMINPWD"]."'";mysql_query("SET NAMES 'GBK'");$resadmin=mysql_query($sqladmin);if(!$rowadmin=mysql_fetch_array($resadmin)){$_SESSION["SHOPADMIN"]="";$_SESSION["SHOPADMINPWD"]="";php_toheader("./");}else{$adminqx=$rowadmin[qx];}}
